...
This weekend, I built a [language server](https://microsoft.github.io/language-server-protocol/) for [<abbr title="Common Expression Language">CEL</abbr>](https://cel.dev) called [`cells`](https://github.com/stefanvanburen/cells).
...
Building this out, I brought over some of the ideas that I had integrated when I was building out some of the [Buf <abbr title="Language Server Protocol">LSP</abbr> server](https://buf.build/docs/cli/editors-lsp/) at `$WORK`,
...
and then "write" our own [<abbr title="JSON Remote Procedure Call">JSONRPC</abbr>](https://www.jsonrpc.org/specification) server,
...
similar to [`gopls`' <abbr title="Command-Line Interface">CLI</abbr> interface](https://go.dev/gopls/command-line).
